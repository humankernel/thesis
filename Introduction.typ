...
presentan barreras significativas en este contexto. Por un lado, su dependencia de conexión estable a internet y hardware avanzado los hace inaccesibles para muchos investigadores cubanos. Por otro, están optimizados para el inglés y no priorizan el español, lo que limita su precisión en documentos científicos locales. A esto se suma la incapacidad de procesar eficientemente PDFs complejos (con tablas, ecuaciones o gráficos) y la falta de adaptación a temas específicos de interés para Cuba, lo que reduce su utilidad práctica en escenarios reales de investigación. 

A partir de la problematica anteriormente descrita se plantea como *problema de investigación*: ¿Cómo desarrollar una herramienta de IA accesible, eficiente y localizable que permita a investigadores cubanos analizar documentos científicos en PDF de forma automatizada, aprovechando LLMs y Generación-Aumentada por Recuperación (RAG), sin depender de infraestructura costosa o conexión estable a internet?, teniendo como *objeto de estudio*: Modelos del lenguaje grandes (LLM). Como *campo de acción*: Extensión de LLMs basado en RAG.
